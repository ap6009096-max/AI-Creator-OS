...
class ExportAgent(BaseAgent):
    ...
    def run(
        ...
        **_: Any,
        ...
        analytics_dst = ""
        analytics_src = root / "analysis" / "analytics.json"
        if analytics_src.is_file():
            dest = exports / "analytics.json"
            self._safe_copy(analytics_src, dest)
            if dest.is_file():
                analytics_dst = str(dest)
